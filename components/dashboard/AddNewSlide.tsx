...
const AddNewSlide: React.FC<Toggles> = ({toggle, setToggle, onLoad})=> {
     ...
     const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
      ...
      // send slide data
      const sendSlide = async(e: FormEvent) => {
        e.preventDefault()
    ...
    return (
        ...
        >
          ...
          className="w-full flex flex-col gap-2.5">
            <h3 className="text-[23px] font-bold text-right" dir="rtl"> يمكنك إضافة slide جديده  </h3>
            <p className="mb-4 text-gray-600 text-lg text-right" dir="rtl">أدخل بيانات ال slide</p>
